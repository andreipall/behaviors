 ...
 */
export default async function* initFBUserCommunityFeedBehaviorIterator(cliAPI) {
...
export const metadata = {
  name: 'facebookCommunityFeed',
  displayName: 'Facebook Community Page',
  match: {
    regex: /^https?:\/\/((www|nl-nl)\.)?facebook\.com\/pg\/[a-zA-Z\d-_]+\/community\/\?ref=page_internal$/,
  },
  description:
